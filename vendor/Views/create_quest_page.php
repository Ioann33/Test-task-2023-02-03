    ...
    <div class="row bg-white shadow-sm">
        <div class="col border rounded p-4">
            ...
            <form style="width: 800px" action="/question/save" method="post">
                ...
                <button type="submit" class="btn btn-primary w-25 mt-2 save-btn">Save</button>
            </form>
        </div>
    </div>
</div>
